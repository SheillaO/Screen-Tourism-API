export const data = [
  {
    ...
    details: [
      {
        fun_fact:
          "The set was rebuilt to be permanent after The Hobbit — complete with real vegetable gardens maintained year-round.",
      },
      {
        description:
          "A fully reconstructed movie set in the heart of New Zealand's Waikato farmland, featuring 44 hobbit holes and the Green Dragon Inn.",
      },
    ],
    tourism_data: {
  ...
  // 2. IRELAND - Giant's Causeway
  {
    ...
    details: [
      {
        fun_fact:
          "The hexagonal columns are formed by ancient volcanic activity — AND doubled as Westeros filming locations.",
      },
      {
        description:
    ...
    featured_in: [
      {
        ...
        tourism_impact:
          "+350% visitors in 2022, became K-drama pilgrimage site",
      },
    ],
    details: [
      {
        fun_fact:
          "Local residents erected unofficial 'Squid Game photo zones' with props from the show within weeks of its release.",
      },
      {
        description:
          "A small tidal island near Incheon known for its dramatic coastal cliffs and scenic hiking trails — now famous as a Squid Game filming location.",
      },
    ],
    tourism_data: {
  ...
  // 4. IRELAND - Skellig Michael (Star Wars)
  {
    ...
    details: [
      {
        fun_fact:
          "This 6th-century monastery became a Star Wars pilgrimage site — UNESCO now limits visitors to protect ancient ruins.",
      },
      {
        description:
          "A UNESCO World Heritage Site featuring an ancient Christian monastery perched on a rocky island 12km off Ireland's coast.",
      },
    ],
    tourism_data: {
    ...
    economic_impact: {
      ...
      main_beneficiaries: [
        "Boat operators (Portmagee)",
        "Kerry hotels",
        "Star Wars tour guides",
      ],
    ...
    traveler_tips: {
      ...
      insider_tip:
        "Book 6+ months ahead, have backup dates (weather cancellations common)",
    },
  ...
  // 5. USA - Maui (White Lotus)
  {
    ...
    featured_in: [
      {
        ...
        tourism_impact:
          "+60% resort bookings post-premiere, waitlist through 2023",
      },
    ],
    details: [
      {
        fun_fact:
          "The resort's actual guests were asked to sign NDAs during filming — some appear as extras in background shots.",
      },
      {
        description:
          "A luxury beachfront resort in Wailea, Maui, featuring pristine beaches, world-class dining, and the infinity pool from THAT opening scene.",
      },
    ],
    tourism_data: {
    ...
    traveler_tips: {
      ...
      permits_required: false,
      budget_alternative:
        "Public beach access is free. Stay in Kihei (15 min away) to save $$$. You can still visit the beach and take photos.",
  ...
  // 6. ICELAND - Secret Life of Walter Mitty
  {
    ...
    details: [
      {
        fun_fact:
          "Tourism officials credit Walter Mitty for making Iceland 'cool' — visitor numbers jumped from 500K to 2.3M (2013-2018).",
      },
      {
        description:
          "A 60-meter cascading waterfall along Iceland's Ring Road, famous for its rainbow mist and dramatic basalt cliffs.",
      },
    ],
    tourism_data: {
    ...
    social_media: {
      ...
      post_count: 524000,
      viral_moment:
        "Ben Stiller's anniversary post recreating skateboard scene (2023)",
    ...
    economic_impact: {
      ...
      main_beneficiaries: [
        "Reykjavik tour companies",
        "South Coast hotels",
        "Ring Road gas stations",
      ],
      sustainability_rating: "Medium - over-tourism stress on infrastructure",
    },
    traveler_tips: {
      best_time_to_visit:
        "May or September (fewer crowds, northern lights possible)",
      ...
      permits_required: false,
      combo_tours:
        "Pair with Seljalandsfoss (15 min away) and black sand beaches",
    },
  ...
  // 7. MOROCCO - Game of Thrones (Essaouira)
  {
    ...
    details: [
      {
        fun_fact:
          "The blue-and-white medina stood in for Astapor with minimal set decoration — locals joke they live in Slaver's Bay.",
      },
      {
        description:
          "A UNESCO-listed coastal town with whitewashed buildings, blue shutters, and a historic Portuguese fortress.",
      },
    ],
    tourism_data: {
    ...
    traveler_tips: {
      best_time_to_visit:
        "April (Gnaoua music festival) or October (uncrowded)",
      difficulty_level: "Easy (flat coastal town)",
      what_to_bring: [
        "Windbreaker (constant ocean breeze)",
        "Cash (many riads don't take cards)",
        "Sunscreen",
      ],
      permits_required: false,
      local_cuisine: "Fresh grilled fish at the port, under $10",
      insider_tip:
        "Stay in a riad inside the medina walls for authentic experience",
    },
  ...
  // 8. JORDAN - Indiana Jones (Petra)
  {
    ...
    featured_in: [
      {
        ...
        tourism_impact:
          "+300% visitors after release, sustained global icon status",
      },
      {
    ...
    details: [
      {
        fun_fact:
          "The Treasury is only the entrance — 85% of Petra's rock-carved city is still hidden behind it, rarely seen in films.",
      },
      {
        description:
          "A UNESCO World Heritage Site featuring a 2,000-year-old rock-carved city, crowned by the iconic Treasury facade.",
      },
    ],
    tourism_data: {
      ...
      accessibility:
        "Moderate (1km walk through canyon to Treasury, further sites require hiking)",
      booking_required: true,
      unesco_site: true,
    },
    social_media: {
      ...
      post_count: 1200000,
      viral_moment:
        "Harrison Ford's 80th birthday tribute post at Petra (2022)",
      best_photo_spot:
        "Treasury framed by Siq canyon exit (arrive 6am for no crowds)",
    ...
    traveler_tips: {
      ...
      difficulty_level:
        "Moderate to Challenging (lots of walking, optional hikes steep)",
      what_to_bring: [
        "Hiking boots",
        "3+ liters water",
        "Hat and sunscreen",
        "Cash for Bedouin tea/donkey rides",
      ],
      permits_required: true,
      ticket_cost: "$70 (1 day), $77 (2 days)",
      insider_tip:
        "Stay overnight in Wadi Musa to catch sunrise at Treasury before tour groups arrive (9am+)",
    },
  ...
  // 9. THAILAND - The Beach (Maya Bay)
  {
    ...
    featured_in: [
      {
        ...
        tourism_impact:
          "+600% visitors, had to close 2018-2022 for environmental recovery",
      },
    ],
    details: [
      {
        fun_fact:
          "The beach was CLOSED for 4 years (2018-2022) to recover from over-tourism damage caused by the movie's fame.",
      },
      {
        description:
          "A stunning turquoise bay surrounded by limestone cliffs, made famous by The Beach — and infamous for environmental collapse.",
      },
    ],
    tourism_data: {
      annual_visitors: 450000,
    ...
    social_media: {
      ...
      post_count: 680000,
      viral_moment:
        "Closure announcement (2018) sparked global environmental tourism debate",
    ...
    economic_impact: {
      ...
      main_beneficiaries: [
        "Phi Phi tour operators",
        "Krabi hotels",
        "Marine conservation NGOs",
      ],
      sustainability_rating:
        "Improving - strict limits enforced post-reopening",
    },
    traveler_tips: {
      ...
      permits_required: true,
      new_rules:
        "No beach landing, swimming from boats only, max 375 visitors/day, no single-use plastics",
      insider_tip:
        "Visit Bamboo Island instead — similar beauty, fewer restrictions, better snorkeling",
    },
  ...
  // 10. CROATIA - Game of Thrones (Dubrovnik)
  {
    ...
    featured_in: [
      {
        ...
        platform: "HBO Max",
        scene:
          "King's Landing - entire city setting, Walk of Shame steps, Red Keep",
        tourism_impact:
          "+550% visitors, cruise ships increased from 300 to 800/year",
      },
      {
        title: "Star Wars: The Last Jedi",
        year: "2017",
    ...
    details: [
      {
        fun_fact:
          "UNESCO threatened to delist Dubrovnik due to Game of Thrones over-tourism — city now caps daily visitors at 4,000.",
      },
      {
        description:
          "A stunning medieval walled city on Croatia's Adriatic coast — the real-world King's Landing complete with limestone streets and fortress walls.",
      },
    ],
    tourism_data: {
    ...
    economic_impact: {
      ...
      main_beneficiaries: [
        "Old Town restaurants (prices tripled)",
        "GoT tour guides",
        "Airbnb owners",
      ],
    ...
    traveler_tips: {
      best_time_to_visit:
        "May or October (shoulder season, fewer cruise ships)",
      difficulty_level: "Moderate (lots of stairs, steep climbs on walls)",
      what_to_bring: [
        "Comfortable shoes (cobblestones)",
        "Water bottle",
        "Early alarm (visit 7-9am)",
      ],
      permits_required: false,
      cost_saving:
        "Skip the GoT tour ($80+) — just walk the walls ($35) and use free podcast guide",
      insider_tip:
        "Stay in Lapad or Gruž neighborhoods (cheaper, quieter) and bus to Old Town",
    },
  ...
  // 11. JAPAN - Lost in Translation (Tokyo)
  {
    ...
    featured_in: [
      {
        ...
        platform: "Netflix",
        scene:
          "Hotel bar scenes, Bill Murray's entire stay, iconic window view",
        tourism_impact:
          "+45% Park Hyatt bookings, New York Bar became pilgrimage site",
      },
    ],
    details: [
      {
        fun_fact:
          "The New York Bar where Bill Murray and Scarlett Johansson met still plays jazz nightly — tourists book months ahead for the 'Lost in Translation booth.'",
      },
      {
        description:
          "A luxury hotel occupying floors 39-52 of Shinjuku Park Tower, famous for its atmospheric bar with sweeping Tokyo night views.",
      },
    ],
    tourism_data: {
      annual_visitors: "Private hotel (guests + bar patrons)",
      peak_season:
        "March-April (cherry blossoms), October-November (fall colors)",
    ...
    traveler_tips: {
      ...
      what_to_bring: [
        "Smart casual attire (dress code enforced)",
        "¥5,000 minimum for bar",
      ],
      permits_required: false,
      budget_alternative:
        "Visit the bar for drinks ($25 cocktails) instead of staying ($600/night). Arrive 5pm for best window seats.",
      insider_tip:
        "Request the corner booth where Bill Murray sat — staff know it well",
    },
  ...
  // 12. SCOTLAND - Harry Potter (Glenfinnan Viaduct)
  {
    ...
    featured_in: [
      {
        ...
        tourism_impact:
          "+300% visitors, Jacobite Steam Train ridership up 250%",
      },
    ],
    details: [
      {
        fun_fact:
          "The Jacobite Steam Train runs daily Apr-Oct — passengers reenact Harry Potter scenes hanging out windows (not recommended).",
      },
      {
        description:
          "A 21-arch railway viaduct built in 1901, now famous as the Hogwarts Express bridge spanning a Highland valley.",
      },
    ],
    tourism_data: {
    ...
    traveler_tips: {
      ...
      what_to_bring: [
        "Midge repellent (essential May-Sep)",
        "Binoculars",
        "Rain gear",
        "Train timetable",
      ],
      ...
      insider_tip:
        "Arrive 45min early to secure viewpoint spot — it gets PACKED when train approaches",
    },
  ...
  // 13. TUNISIA - Star Wars (Tatooine)
  {
    ...
    featured_in: [
      {
        ...
        platform: "Disney+",
        scene:
          "Luke Skywalker's home planet Tatooine - underground homes, desert scenes",
        tourism_impact:
          "+200% visitors, sets left in desert became permanent attractions",
      },
      {
    ...
    details: [
      {
        fun_fact:
          "The underground troglodyte homes in Matmata are REAL homes where locals still live — you can stay overnight in Luke's actual house (now Hotel Sidi Driss).",
      },
      {
        description:
          "A Berber village of ancient underground cave homes and nearby desert film sets, forming the real-world Tatooine.",
      },
    ],
    tourism_data: {
    ...
    economic_impact: {
      ...
      main_beneficiaries: [
        "Matmata hotels",
        "4WD tour guides",
        "Berber families hosting tourists",
      ],
      sustainability_rating:
        "High - tourism supports traditional cave dwelling preservation",
    },
    traveler_tips: {
      ...
      what_to_bring: [
        "Sunscreen",
        "Long sleeves (desert sun)",
        "Cash (ATMs scarce)",
        "Star Wars references (locals love them)",
      ],
      permits_required: false,
      must_do: "Sleep in Luke's actual bedroom at Hotel Sidi Driss ($25/night)",
      insider_tip:
        "Hire local guide to find all 7 abandoned sets — GPS coordinates online are often wrong",
    },
  ...
  // 14. ITALY - Roman Holiday (Rome)
  {
    ...
    featured_in: [
      {
        ...
        tourism_impact:
          "Created 70+ years of sustained tourism, average 300 person daily queue",
      },
    ],
    details: [
      {
        fun_fact:
          "The Mouth of Truth is a 2,000-year-old drain cover — legend says it bites off liars' hands. Tourists still reenact Audrey Hepburn's scream daily.",
      },
      {
        description:
          "An ancient marble mask in the portico of Santa Maria in Cosmedin church, made iconic by Roman Holiday.",
      },
    ],
    tourism_data: {
    ...
    social_media: {
      ...
      post_count: 215000,
      viral_moment:
        "Every proposal where someone hides ring in the mouth (weekly)",
    ...
    traveler_tips: {
      ...
      insider_tip:
        "Visit during church mass (Sunday 10:30am) — most tourists skip it, no queue",
    },
  ...
  // 15. NORWAY - Frozen (Fjords)
  {
    ...
    featured_in: [
      {
        ...
        tourism_impact:
          "+37% Norway tourism from families, 'Frozen tours' created",
      },
      {
        title: "Frozen II",
        year: "2019",
        ...
        tourism_impact:
          "Sustained family tourism, Northern Lights tours marketed to Frozen fans",
      },
    ],
    details: [
      {
        fun_fact:
          "Disney animators spent 3 weeks in Norway researching fjords, stave churches, and Sami culture — Arendelle is a mashup of Bergen, Oslo, and these UNESCO fjords.",
      },
      {
        description:
          "A UNESCO World Heritage fjord featuring dramatic cliffs, waterfalls, and traditional villages — the real-world inspiration for Elsa's kingdom.",
      },
    ],
    tourism_data: {
      annual_visitors: 450000,
    ...
    social_media: {
      ...
      post_count: 78000,
      viral_moment:
        "Kristen Bell's Norway travel vlog (2019) visiting Frozen locations",
    ...
    traveler_tips: {
      ...
      difficulty_level:
        "Easy to Moderate (boat access easy, optional hikes challenging)",
      what_to_bring: [
        "Layers (weather changes fast)",
        "Waterproof jacket",
        "Binoculars for waterfalls",
      ],
      permits_required: false,
      must_do:
        "Flåm Railway to Myrdal (one of world's steepest trains, stunning views)",
      insider_tip:
        "Book morning fjord cruise — afternoon often has cruise ship traffic",
    },
